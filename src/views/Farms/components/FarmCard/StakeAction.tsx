...
const StakeAction: React.FC<FarmCardActionsProps> = ({ stakedBalance, tokenBalance, tokenName, pid, depositFeeBP }) => {
  ...
  const renderStakingButtons = () => {
    return rawStakedBalance === 0 ? (
      <Button2 style={{padding: '0 40px', borderRadius: 180}} variant="contained" color="primary" className="farm_card_unlock_btn" onClick={onPresentDeposit}>{TranslateString(999, 'Stake')}</Button2>
    ) : (
      <IconButtonWrapper>
